...
`;new Function("module","require","window","jQuery",src)({},()=>$,window,$);function initSelect2(){$(".fos-select2").select2({placeholder:"Select a fos"})}function initForm(){$(document).on("click","#form_reset_button",function(){resetForm($("#filter_form"))});const n=[["selectAll","attributeform-"],["selectAllAllocations","allocationform-"],["selectAll","userform-"],["selectAll","users"],["selectAll","noteform-"],["selectAll","grantform-"],["selectAll","pubform-"],["selectAll","grantdownloadform-"]];for(const t of n)$("#"+t[0]).click(function(){$("input[name^='"+t[1]+"']").prop("checked",$(this).prop("checked"))}),$("input[name^='"+t[1]+"']").click(function(){$(this).attr("id")!=t[0]&&$("#"+t[0]).prop("checked",!1)})}function resetForm(n){n.find("input:text, input:password, input:file, select, textarea").val(""),n.find("input:radio, input:checkbox").removeAttr("checked").removeAttr("selected")}function initDataTable(){const n=document.querySelectorAll("div.table-responsive > table.datatable");for(const e of n)e!==null&&new DataTable(e,{pageLength:10,orderClasses:!1,order:[[1,"desc"]]});const t=document.querySelectorAll("div.table-responsive > table.datatable-long");for(const e of t)e!==null&&new DataTable(e,{pageLength:50,orderClasses:!1,order:[[1,"desc"]]})}function buildNativeHelpText(n){const t=n.getAttribute("title")||n.dataset.bsTitle||"",e=n.dataset.bsContent||"";return t&&e&&t!==e?`${t}: ${e}`:e||t||null}function initBootstrap(){for(const n of getElementsByQueryGenerator('[data-bs-toggle="tooltip"]')){const t=buildNativeHelpText(n);t&&(n.setAttribute("title",t),n.setAttribute("aria-label",t),Tooltip.getOrCreateInstance(n))}for(const n of getElementsByQueryGenerator('[data-bs-toggle="popover"]')){const t=buildNativeHelpText(n);t&&(n.setAttribute("title",t),n.setAttribute("aria-label",t),Popover.getOrCreateInstance(n))}}Object.assign(window,{getCookie:function(n){getCookie(n)},drawGauges:function(n){drawGauges(n)},$,jQuery:$,bootstrap:{Alert,Collapse,Dropdown,Modal,Popover,Tooltip}});function initDocument(){for(const n of[initDateSelector,initSelect2,initForm,initDataTable,initBootstrap])n()}document.readyState!=="loading"?initDocument():document.addEventListener("DOMContentLoaded",initDocument);
