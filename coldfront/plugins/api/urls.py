...
router.register(
    r"allocation-requests",
    views.AllocationRequestViewSet,
    basename="allocation-requests",
)
router.register(
    r"allocation-change-requests",
    views.AllocationChangeRequestViewSet,
    basename="allocation-change-requests",
)
